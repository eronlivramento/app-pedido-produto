...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">AppProduto</a>
    </div>
    <ul class="nav navbar-nav">
	  ...
	  <c:if test="${not empty user}">
	      ...
	      <li class="nav-item">
	        <a class="nav-link" href="/escritorio/lista">Escritorio</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="/eletroeletronico/lista">Eletroeletronico</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="/eletrodomestico/lista">Eletrodomestico</a>
	      </li>
	      <li class="nav-item">
